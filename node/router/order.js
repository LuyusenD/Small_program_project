...
router.post('/addOrder', (req, res) => {
  let sql = `INSERT INTO the_order (oId, oName, oTel, oAddress, createTime, deleteTime, oType, oStart, oTime, oRemark, openId) VALUES (?,?,?,?,?,?,?,?,?,?,?)`
  let oId = tools.generateOid(`Z24`),
      time = tools.time(),
      v = req.body
  if (!v.oName || v.oTel || v.oAddress || v.oType || v.oTime || v.oRemark || v.openId ) {
    res.send({code: 9999, data: null, msg: '缺少参数'})
  }
